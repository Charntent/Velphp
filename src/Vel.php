<?php
use  vel\exceptions\NotFoundException;
...
class Vel
{
    ...
    //获取组件
    public static function cp($cls = '')
    {
        if(isset(self::$sysClass[$cls])) {
            return self::$sysClass[$cls]::getInstance();
        }
        throw new NotFoundException('Class '.$cls.' Is Not Exists');
    }
